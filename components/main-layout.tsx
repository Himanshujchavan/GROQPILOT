...
export function MainLayout({ children }: MainLayoutProps) {
  ...
  // Add AI Chat to the navigation links
  const navItems = [
    ...
    { href: "/desktop-automation", label: "Desktop Automation", icon: Terminal },
  ]
  ...
  const navigationLinks = [
    ...
    { href: "/nlp-engine", label: "NLP Engine", icon: Cpu },
    { href: "/desktop-automation", label: "Desktop", icon: Monitor },
