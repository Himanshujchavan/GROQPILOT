...
export default function LoginPage() {
  ...
  const handleTestLogin = () => {
    // For Firebase demo mode, use these test credentials
    ...
    toast({
      ...
      description:
        "You can now click Login to test the authentication. Note: In demo mode, these credentials won't actually authenticate.",
    })
    ...
    if (!isFirebaseConfigured) {
      toast({
        title: "Firebase not configured",
        description: "Please add your Firebase credentials in the environment variables to enable authentication.",
        variant: "destructive",
      })
    }
  }
